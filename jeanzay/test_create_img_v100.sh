...
python evaluate_quant_metrics.py --path /lustre/fsn1/projects/rech/abj/ujq24es/results_inter_bs128/flair_pix2pix/test_latest/images/ --method flair_pix2pix_v100_bs128 --output_path /lustre/fsn1/projects/rech/abj/ujq24es/results_pix2pix