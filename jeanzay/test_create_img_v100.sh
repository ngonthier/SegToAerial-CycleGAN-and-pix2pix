...
# Execution du code
python test.py --dataroot /lustre/fsn1/projects/rech/abj/ujq24es/dataset/PixtoPix_FLAIR --num_test 50 --name flair_pix2pix_v100 --model pix2pix --direction AtoB --dataset_mode aligned --results_dir './results/'
python evaluate_quant_metrics.py --path './results/' --method flair_pix2pix_v100