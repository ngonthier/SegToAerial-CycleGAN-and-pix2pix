#!/bin/bash
#SBATCH --job-name=combine_dataset          # nom du job
...
# Execution du code
python datasets/combine_A_and_B.py --fold_A /lustre/fsn1/projects/rech/abj/ujq24es/dataset/PixtoPix_FLAIR/A --fold_B /lustre/fsn1/projects/rech/abj/ujq24es/dataset/PixtoPix_FLAIR/B --fold_AB /lustre/fsn1/projects/rech/abj/ujq24es/dataset/PixtoPix_FLAIR
## --no_multiprocessing 