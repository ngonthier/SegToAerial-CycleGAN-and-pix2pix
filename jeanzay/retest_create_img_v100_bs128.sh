#!/bin/bash
#SBATCH --job-name=create_test_img_eval    # nom du job
...
# Execution du code
#python test.py --dataroot /lustre/fsn1/projects/rech/abj/ujq24es/dataset/PixtoPix_FLAIR --num_test 31750 --name flair_pix2pix_v100_bs128 --model pix2pix --direction AtoB --dataset_mode aligned --results_dir /lustre/fsn1/projects/rech/abj/ujq24es/results_inter/
python evaluate_quant_metrics.py --path /lustre/fsn1/projects/rech/abj/ujq24es/results_inter/flair_pix2pix_v100_bs128/test_latest/images/ --method flair_pix2pix_v100_bs128 --output_path /lustre/fsn1/projects/rech/abj/ujq24es/results_pix2pix_bs128