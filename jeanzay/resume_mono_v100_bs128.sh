...
#SBATCH --time=60:00:00              # temps maximum d'execution demande (HH:MM:SS)
...
python train.py --dataroot /lustre/fsn1/projects/rech/abj/ujq24es/dataset/PixtoPix_FLAIR --name flair_pix2pix_v100 --model pix2pix --direction AtoB --display_id -1 --dataset_mode aligned --batch_size 128 --continue_train --epoch_count 138
